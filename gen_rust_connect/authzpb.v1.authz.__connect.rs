...
pub type OwnedTupleView = ::buffa::view::OwnedView<
    crate::gen_rust::authzpb::v1::__buffa::view::TupleView<'static>,
>;
...
pub type OwnedListTuplesInView = ::buffa::view::OwnedView<
    crate::gen_rust::authzpb::v1::__buffa::view::ListTuplesInView<'static>,
>;
///Shorthand for `OwnedView<ListTuplesOutView<'static>>`.
pub type OwnedListTuplesOutView = ::buffa::view::OwnedView<
    crate::gen_rust::authzpb::v1::__buffa::view::ListTuplesOutView<'static>,
>;
///Shorthand for `OwnedView<DeleteTuplesInView<'static>>`.
pub type OwnedDeleteTuplesInView = ::buffa::view::OwnedView<
    crate::gen_rust::authzpb::v1::__buffa::view::DeleteTuplesInView<'static>,
>;
///Shorthand for `OwnedView<CheckInView<'static>>`.
pub type OwnedCheckInView = ::buffa::view::OwnedView<
    crate::gen_rust::authzpb::v1::__buffa::view::CheckInView<'static>,
>;
///Shorthand for `OwnedView<CheckOutView<'static>>`.
pub type OwnedCheckOutView = ::buffa::view::OwnedView<
    crate::gen_rust::authzpb::v1::__buffa::view::CheckOutView<'static>,
>;
impl ::connectrpc::Encodable<crate::gen_rust::authzpb::v1::ListTuplesOut>
for crate::gen_rust::authzpb::v1::__buffa::view::ListTuplesOutView<'_> {
    fn encode(
        &self,
...
impl ::connectrpc::Encodable<crate::gen_rust::authzpb::v1::CheckOut>
for crate::gen_rust::authzpb::v1::__buffa::view::CheckOutView<'_> {
    fn encode(
        &self,
        codec: ::connectrpc::CodecFormat,
    ) -> ::std::result::Result<::buffa::bytes::Bytes, ::connectrpc::ConnectError> {
...
pub const AUTHZ_SERVICE_SERVICE_NAME: &str = "authzpb.v1.AuthzService";
...
pub const AUTHZ_SERVICE_CREATE_TUPLE_SPEC: ::connectrpc::Spec = ::connectrpc::Spec::server(
        "/authzpb.v1.AuthzService/CreateTuple",
...
pub const AUTHZ_SERVICE_LIST_TUPLES_SPEC: ::connectrpc::Spec = ::connectrpc::Spec::server(
        "/authzpb.v1.AuthzService/ListTuples",
        ::connectrpc::StreamType::Unary,
    )
    .with_idempotency_level(::connectrpc::IdempotencyLevel::Unknown);
...
pub const AUTHZ_SERVICE_DELETE_TUPLES_SPEC: ::connectrpc::Spec = ::connectrpc::Spec::server(
        "/authzpb.v1.AuthzService/DeleteTuples",
        ::connectrpc::StreamType::Unary,
    )
    .with_idempotency_level(::connectrpc::IdempotencyLevel::Unknown);
...
pub trait AuthzService: Send + Sync + 'static {
    ...
    fn list_tuples<'a>(
        ...
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
                crate::gen_rust::authzpb::v1::ListTuplesOut,
            > + Send + use<'a, Self>,
        >,
    > + Send;
    ...
    fn check<'a>(
        ...
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
                crate::gen_rust::authzpb::v1::CheckOut,
            > + Send + use<'a, Self>,
        >,
    > + Send;
}
                ...
                "Check",
                {
                    ...
                    ::connectrpc::view_handler_fn(move |ctx, req, format| {
                        ...
                        async move {
                            svc.check(ctx, req)
                                .await?
                                .encode::<crate::gen_rust::authzpb::v1::CheckOut>(format)
                        }
                    })
                },
            )
...
impl<T: AuthzService> ::connectrpc::Dispatcher for AuthzServiceServer<T> {
    ...
    fn lookup(
        ...
        let method = path.strip_prefix("authzpb.v1.AuthzService/")?;
        match method {
            "CreateTuple" => {
                Some(
    ...
    fn call_unary(
        ...
        let Some(method) = path.strip_prefix("authzpb.v1.AuthzService/") else {
        ...
        match method {
            "CreateTuple" => {
                ...
                Box::pin(async move {
                    let req = ::connectrpc::dispatcher::codegen::decode_request_view::<
                        crate::gen_rust::authzpb::v1::__buffa::view::TupleView,
            ...
            "ListTuples" => {
                ...
                Box::pin(async move {
                    let req = ::connectrpc::dispatcher::codegen::decode_request_view::<
                        crate::gen_rust::authzpb::v1::__buffa::view::ListTuplesInView,
                    >(request.encoded()?, format)?;
                    svc.list_tuples(ctx, req)
                        .await?
                        .encode::<crate::gen_rust::authzpb::v1::ListTuplesOut>(format)
                })
            }
            "DeleteTuples" => {
                let svc = ::std::sync::Arc::clone(&self.inner);
                Box::pin(async move {
                    let req = ::connectrpc::dispatcher::codegen::decode_request_view::<
                        crate::gen_rust::authzpb::v1::__buffa::view::DeleteTuplesInView,
                    >(request.encoded()?, format)?;
                    svc.delete_tuples(ctx, req)
                        .await?
                        .encode::<::buffa_types::google::protobuf::Empty>(format)
            ...
            "Check" => {
                ...
                Box::pin(async move {
                    let req = ::connectrpc::dispatcher::codegen::decode_request_view::<
                        crate::gen_rust::authzpb::v1::__buffa::view::CheckInView,
                    >(request.encoded()?, format)?;
                    svc.check(ctx, req)
                        .await?
                        .encode::<crate::gen_rust::authzpb::v1::CheckOut>(format)
    ...
    <T::ResponseBody as ::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    /// Call the CreateTuple RPC. Sends a request to /authzpb.v1.AuthzService/CreateTuple.
    pub async fn create_tuple(
        &self,
        request: crate::gen_rust::authzpb::v1::Tuple,
    ) -> Result<
    ...
    /// Call the ListTuples RPC. Sends a request to /authzpb.v1.AuthzService/ListTuples.
    pub async fn list_tuples(
        &self,
        request: crate::gen_rust::authzpb::v1::ListTuplesIn,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                crate::gen_rust::authzpb::v1::__buffa::view::ListTuplesOutView<'static>,
    ...
    /// Call the DeleteTuples RPC. Sends a request to /authzpb.v1.AuthzService/DeleteTuples.
    pub async fn delete_tuples(
        &self,
        request: crate::gen_rust::authzpb::v1::DeleteTuplesIn,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                ::buffa_types::google::protobuf::__buffa::view::EmptyView<'static>,
    ...
    /// Call the Check RPC. Sends a request to /authzpb.v1.AuthzService/Check.
    pub async fn check(
        &self,
        request: crate::gen_rust::authzpb::v1::CheckIn,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                crate::gen_rust::authzpb::v1::__buffa::view::CheckOutView<'static>,
