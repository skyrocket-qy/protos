...
const (
	...
	SlotServiceName = "slotpb.SlotService"
)
...
func NewSlotServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SlotServiceClient {
	...
	slotServiceMethods := slotpb.File_slotpb_slot_proto.Services().ByName("SlotService").Methods()
	return &slotServiceClient{
		spin: connect.NewClient[slotpb.SpinReq, slotpb.SpinResp](
			httpClient,
...
func (c *slotServiceClient) Spin(ctx context.Context, req *connect.Request[slotpb.SpinReq]) (*connect.Response[slotpb.SpinResp], error) {
