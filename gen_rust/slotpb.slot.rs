...
impl ::core::fmt::Debug for BigSym {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("BigSym").field("id", &self.id).field("len", &self.len).finish()
    }
}
impl BigSym {
    /// Protobuf type URL for this message, for use with `Any::pack` and
    ...
    ///
    /// Format: `type.googleapis.com/<fully.qualified.TypeName>`
    pub const TYPE_URL: &'static str = "type.googleapis.com/slotpb.BigSym";
}
impl ::buffa::DefaultInstance for BigSym {
    fn default_instance() -> &'static Self {
        static VALUE: ::buffa::__private::OnceBox<BigSym> = ::buffa::__private::OnceBox::new();
        VALUE.get_or_init(|| ::buffa::alloc::boxed::Box::new(Self::default()))
    }
}
impl ::buffa::MessageName for BigSym {
    const PACKAGE: &'static str = "slotpb";
    const NAME: &'static str = "BigSym";
    const FULL_NAME: &'static str = "slotpb.BigSym";
    const TYPE_URL: &'static str = "type.googleapis.com/slotpb.BigSym";
}
impl ::buffa::Message for BigSym {
    /// Returns the total encoded size in bytes.
    ///
    /// The result is a `u32`; the protobuf specification requires all
    /// messages to fit within 2 GiB (2,147,483,647 bytes), so a
    ...
    fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        ...
        if self.len != 0u32 {
            size += 1u32 + ::buffa::types::uint32_encoded_len(self.len) as u32;
        }
        size += self.__buffa_unknown_fields.encoded_len() as u32;
        size
    }
    fn write_to(
        ...
        if self.len != 0u32 {
            ::buffa::encoding::Tag::new(2u32, ::buffa::encoding::WireType::Varint)
                .encode(buf);
            ::buffa::types::encode_uint32(self.len, buf);
        }
        self.__buffa_unknown_fields.write_to(buf);
    }
    fn merge_field(
        ...
        match tag.field_number() {
            ...
            2u32 => {
                ...
                self.len = ::buffa::types::decode_uint32(buf)?;
            }
            _ => {
                self.__buffa_unknown_fields
                    .push(::buffa::encoding::decode_unknown_field(tag, buf, depth)?);
...
impl ::buffa::ExtensionSet for BigSym {
    const PROTO_FQN: &'static str = "slotpb.BigSym";
    fn unknown_fields(&self) -> &::buffa::UnknownFields {
        &self.__buffa_unknown_fields
    }
    fn unknown_fields_mut(&mut self) -> &mut ::buffa::UnknownFields {
...
impl ::buffa::json_helpers::ProtoElemJson for BigSym {
    fn serialize_proto_json<S: ::serde::Serializer>(
        v: &Self,
        s: S,
    ) -> ::core::result::Result<S::Ok, S::Error> {
...
#[doc(hidden)]
pub const __BIG_SYM_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/slotpb.BigSym",
    to_json: ::buffa::type_registry::any_to_json::<BigSym>,
    from_json: ::buffa::type_registry::any_from_json::<BigSym>,
    is_wkt: false,
};
